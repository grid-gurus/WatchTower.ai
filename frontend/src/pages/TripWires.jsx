...
export default function TripWires() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] via-[#020617] to-[#000000] text-white overflow-x-hidden relative">
      ...
      <div className="fixed top-[40%] left-[30%] w-[300px] h-[300px] bg-[#8B7355] opacity-10 blur-[180px] rounded-full"></div>

      {/* Navbar */}
      <Navbar />

      <div className="relative z-10 max-w-5xl mx-auto pt-32 sm:pt-40 px-4">

        {/* Heading */}
        <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-[#D4AF37] to-[#B8962E] bg-clip-text text-transparent">
          🚨 Tripwire Alerts
        </h2>

        {/* Input Section */}
        <div className="p-[1.5px] rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B8962E] mb-8">
          <div className="bg-black rounded-xl p-6 flex gap-4">
            ...
            <input
              ...
              className="flex-1 p-3 rounded-lg bg-white/[0.05] border border-white/10 outline-none focus:border-[#D4AF37]"
            />

            <button
              onClick={handleAdd}
              className="px-6 py-3 rounded-lg bg-gradient-to-r from-[#D4AF37] to-[#B8962E] text-black font-semibold hover:scale-105 transition"
            >
              Add
            </button>
